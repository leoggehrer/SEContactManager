...
namespace SEContactManager.WebApi.Controllers
{
    ...
    /// </summary>
    public sealed partial class ContactsController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
