...
namespace SEContactManager.Logic.DataContext
{
    ...
    partial class ProjectDbContext
    {
        ...
        /// Generated by the generator.
        /// </summary>
        public Contracts.IEntitySet<Entities.Contact> ContactSet => GetEntitySet<Entities.Contact>();
        ...
        partial void GetGeneratorEntitySet<E>(ref EntitySet<E>? entitySet, ref bool handled) where E : Entities.EntityObject, new()
        {
            if (typeof(E) == typeof(Entities.Contact))
            {
                entitySet = new DataContext.ContactSet(this, DbContactSet) as EntitySet<E>;
                handled = true;
            }
        }
        /// <summary>
