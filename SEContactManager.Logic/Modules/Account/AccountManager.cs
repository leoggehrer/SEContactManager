//@CodeCopy
#if ACCOUNT_ON
using SEContactManager.Logic.Entities.Account;
using SEContactManager.Logic.Modules.Exceptions;
using SEContactManager.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEContactManager.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEContactManager.Common.Modules.ThreadSafe;
